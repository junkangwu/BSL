...
sampling_method="${14}"
generate_mode="${15}"
for w1 in 0 0.01 0.05 0.1
do 
    for w2 in 0 0.01 0.05 0.1 0.2 0.5 1 2 5
    do 
        name1="${dataset}_${gnn}_${bsz}_lr_${lr}_l2_${l2}_HOP_${context_hops}_T_${temperature}_t_${temperature_2}_${temperature_3}_cl_rate_${w1}_eps_${w2}_${sampling_method}_${n_negs}_${generate_mode}"
        echo $name1
