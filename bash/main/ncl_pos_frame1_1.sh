...
name1="ICDE_rebuttal_${dataset}_${gnn}_${bsz}_lr_${lr}_l2_${l2}_HOP_${context_hops}_T_${temperature}_hyper_layer_${w1}_ssl_reg_${w2}_alpha_${w3}_proto_reg_${w4}_K_${K}_DIM_${dim}"
