...
name1="ICDE_check_${dataset}_${gnn}_${bsz}_lr_${lr}_l2_${l2}_HOP_${context_hops}_T_${temperature}_t_${temperature_2}_${temperature_3}_cl_rate_${w1}_eps_${w2}_${sampling_method}_${n_negs}_${generate_mode}"
echo $name1
