...
class GraphConv(nn.Module):
    ...
    def sparse_dropout(self, x, rate=0.5, noise_shape=None):
    ...
    def forward(self, user_embed, item_embed,
        ...
        A_hat = self.sparse_dropout(self.interact_mat,
                                    self.edge_dropout_rate,
                                    self.interact_mat._nnz()) if edge_dropout else self.interact_mat

        ego_embeddings = torch.cat([user_embed,
                                    item_embed], 0)
